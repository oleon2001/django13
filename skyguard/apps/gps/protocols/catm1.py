"""
CatM1 protocol implementation for GPS tracking.
"""
import struct
...
class CatM1Position(BasePosition):
    """CatM1 protocol position data."""
    
    def __init__(self, data):
        """Initialize position data from CatM1 packet."""
        super().__init__()
...
class CatM1Protocol(BaseProtocol):
    """CatM1 protocol implementation."""
    
    def __init__(self):
        """Initialize the CatM1 protocol."""
        super().__init__()
