"""
CYACD protocol implementation for GPS tracking.
"""
import struct
...
class CYACDPosition(BasePosition):
    """CYACD protocol position data."""
    
    def __init__(self, data):
        """Initialize position data from CYACD packet."""
        super().__init__()
...
class CYACDProtocol(BaseProtocol):
    """CYACD protocol implementation."""
    
    def __init__(self):
        """Initialize the CYACD protocol."""
        super().__init__()
