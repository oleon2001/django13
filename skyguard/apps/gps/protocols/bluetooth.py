"""
Bluetooth protocol implementation for GPS tracking.
"""
import struct
...
class BluetoothPosition(BasePosition):
    """Bluetooth protocol position data."""
    
    def __init__(self, data):
        """Initialize position data from Bluetooth packet."""
        super().__init__()
...
class BluetoothProtocol(BaseProtocol):
    ...
    def __init__(self):
        """Initialize the Bluetooth protocol."""
        super().__init__()
    ...
    def decode_position(self, data):
        ...
        return BluetoothPosition(data[3:-3]) 