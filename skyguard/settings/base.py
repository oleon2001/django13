"""
Base settings for the Skyguard project.
"""
import os
...
MIDDLEWARE = [
    ...
    'skyguard.apps.gps.middleware.GPSDeviceActivityMiddleware',  # GPS activity tracking
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'skyguard' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'skyguard'),
